 ...
 */
public class MediaHubMainSubAppViewImpl implements MediaHubMainSubAppView {
    ...
    protected MediaHubMainSubAppView.Listener listener;

    @Inject
    public MediaHubMainSubAppViewImpl(final SimpleTranslator i18n) {
        this.i18n = i18n;
    }
