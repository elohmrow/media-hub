 ...
 */
public class MediaHubConfigSubApp extends BaseSubApp implements MediaHubConfigSubAppView.Listener {
    protected static final Logger log = LoggerFactory.getLogger(MediaHubConfigSubApp.class);

    protected final FormViewReduced formView;
    protected final MediaHubConfigSubAppView view;
    ...
    @Inject
    protected MediaHubConfigSubApp(final SubAppContext subAppContext, final FormViewReduced formView, final MediaHubConfigSubAppView view,
    ...
    @Override
    public MediaHubConfigSubAppView getView() {
        return (MediaHubConfigSubAppView)super.getView();
    }
